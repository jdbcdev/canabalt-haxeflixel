...
class HXCPP_CLASS_ATTRIBUTES  FlxText_obj : public ::flixel::FlxSprite_obj{
	...
	public:
		...
		::openfl::_v2::text::TextField _textField;
		...
		virtual Void addFilter( ::openfl::_v2::filters::BitmapFilter filter,hx::Null< int >  widthInc,hx::Null< int >  heightInc);
		Dynamic addFilter_dyn();

		virtual Void removeFilter( ::openfl::_v2::filters::BitmapFilter filter);
		...
		virtual ::openfl::_v2::text::TextField get_textField( );
		...
		virtual Void updateFormat( ::openfl::_v2::text::TextFormat Format);
