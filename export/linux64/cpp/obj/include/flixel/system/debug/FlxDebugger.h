...
class HXCPP_CLASS_ATTRIBUTES  FlxDebugger_obj : public ::openfl::_v2::display::Sprite_obj{
	...
	public:
		...
		virtual ::flixel::system::ui::FlxSystemButton addButton( ::flixel::system::debug::ButtonAlignment Position,::openfl::_v2::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  ToggleMode,hx::Null< bool >  UpdateLayout);
