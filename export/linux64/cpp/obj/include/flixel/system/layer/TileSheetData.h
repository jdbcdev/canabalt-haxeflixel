...
class HXCPP_CLASS_ATTRIBUTES  TileSheetData_obj : public hx::Object{
	...
	public:
		...
		static hx::ObjectPtr< TileSheetData_obj > __new(::openfl::_v2::display::BitmapData Bitmap);
		...
		virtual ::flixel::system::layer::frames::FlxSpriteFrames getSpriteSheetFrames( ::flixel::system::layer::Region region,::openfl::_v2::geom::Point origin);
		Dynamic getSpriteSheetFrames_dyn();

		virtual ::String getSpriteSheetFrameKey( ::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point);
		...
		virtual ::flixel::system::layer::frames::FlxFrame addSpriteSheetFrame( ::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point);
		Dynamic addSpriteSheetFrame_dyn();

		virtual bool containsFrame( ::String key);
		Dynamic containsFrame_dyn();

		virtual int addTileRect( ::openfl::_v2::geom::Rectangle tileRect,::openfl::_v2::geom::Point point);
		Dynamic addTileRect_dyn();

		virtual Void destroy( );
		Dynamic destroy_dyn();

		virtual Void onContext( ::openfl::_v2::display::BitmapData bitmap);
