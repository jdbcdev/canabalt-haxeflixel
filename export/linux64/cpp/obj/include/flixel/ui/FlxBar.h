...
class HXCPP_CLASS_ATTRIBUTES  FlxBar_obj : public ::flixel::FlxSprite_obj{
	...
	public:
		...
		::openfl::_v2::display::BitmapData emptyBar;
		::openfl::_v2::geom::Rectangle emptyBarRect;
		::openfl::_v2::geom::Point emptyBarPoint;
		bool emptyKill;
		::openfl::_v2::geom::Point zeroOffset;
		Dynamic filledCallback;
		Dynamic &filledCallback_dyn() { return filledCallback;}
		::openfl::_v2::display::BitmapData filledBar;
		::openfl::_v2::geom::Rectangle filledBarRect;
		::openfl::_v2::geom::Point filledBarPoint;
		int fillDirection;
		bool fillHorizontal;
