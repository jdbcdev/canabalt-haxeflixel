...
{
HX_STACK_FRAME("openfl._v2.display.ManagedStage","new",0xae26976e,"openfl._v2.display.ManagedStage.new","openfl/_v2/display/ManagedStage.hx",42,0x9f9d949f)
HX_STACK_THIS(this)
...
{
	HX_STACK_LINE(44)
	Dynamic _g = ::openfl::_v2::display::ManagedStage_obj::lime_managed_stage_create(width,height,flags);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(44)
