...
::openfl::_v2::display::StageQuality StageQuality_obj::BEST;

::openfl::_v2::display::StageQuality StageQuality_obj::HIGH;

::openfl::_v2::display::StageQuality StageQuality_obj::LOW;

::openfl::_v2::display::StageQuality StageQuality_obj::MEDIUM;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.StageQuality"), hx::TCanCast< StageQuality_obj >,sStaticFields,sMemberFields,
