...
::openfl::_v2::display::TriangleCulling TriangleCulling_obj::NEGATIVE;

::openfl::_v2::display::TriangleCulling TriangleCulling_obj::NONE;

::openfl::_v2::display::TriangleCulling TriangleCulling_obj::POSITIVE;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.TriangleCulling"), hx::TCanCast< TriangleCulling_obj >,sStaticFields,sMemberFields,
