...
::openfl::_v2::display::SpreadMethod SpreadMethod_obj::PAD;

::openfl::_v2::display::SpreadMethod SpreadMethod_obj::REFLECT;

::openfl::_v2::display::SpreadMethod SpreadMethod_obj::REPEAT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.SpreadMethod"), hx::TCanCast< SpreadMethod_obj >,sStaticFields,sMemberFields,
