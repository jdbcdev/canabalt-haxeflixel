...
::openfl::_v2::display::JointStyle JointStyle_obj::BEVEL;

::openfl::_v2::display::JointStyle JointStyle_obj::MITER;

::openfl::_v2::display::JointStyle JointStyle_obj::ROUND;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.JointStyle"), hx::TCanCast< JointStyle_obj >,sStaticFields,sMemberFields,
