...
#ifndef INCLUDED_openfl__v2_net_URLRequestMethod
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.net.URLRequestMethod"), hx::TCanCast< URLRequestMethod_obj> ,sStaticFields,sMemberFields,
