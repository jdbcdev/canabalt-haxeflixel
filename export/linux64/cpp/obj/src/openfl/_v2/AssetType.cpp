...
::openfl::_v2::AssetType AssetType_obj::BINARY;

::openfl::_v2::AssetType AssetType_obj::FONT;

::openfl::_v2::AssetType AssetType_obj::IMAGE;

::openfl::_v2::AssetType AssetType_obj::MOVIE_CLIP;

::openfl::_v2::AssetType AssetType_obj::MUSIC;

::openfl::_v2::AssetType AssetType_obj::SOUND;

::openfl::_v2::AssetType AssetType_obj::TEMPLATE;

::openfl::_v2::AssetType AssetType_obj::TEXT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.AssetType"), hx::TCanCast< AssetType_obj >,sStaticFields,sMemberFields,
