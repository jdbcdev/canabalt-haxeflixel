...
bool Rectangle_obj::contains( Float x,Float y){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::openfl::_v2::geom::Rectangle_obj > __this,Float &x){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_v2/geom/Rectangle.hx",39,0xceeaba4f)
			{
				HX_STACK_LINE(39)
...
bool Rectangle_obj::containsRect( ::openfl::_v2::geom::Rectangle rect){
	...
	if (((bool((rect->width <= (int)0)) || bool((rect->height <= (int)0))))){
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::openfl::_v2::geom::Rectangle_obj > __this,::openfl::_v2::geom::Rectangle &rect){
