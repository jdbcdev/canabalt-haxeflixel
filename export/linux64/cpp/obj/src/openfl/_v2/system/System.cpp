...
int code = __o_code.Default(0);
	HX_STACK_FRAME("openfl._v2.system.System","exit",0xb8955d6f,"openfl._v2.system.System.exit","openfl/_v2/system/System.hx",16,0x02b48b82)
	HX_STACK_ARG(code,"code")
{
		HX_STACK_LINE(16)
		::openfl::_v2::Lib_obj::close();
	}
return null();
}
...
Void System_obj::gc( ){
{
		HX_STACK_FRAME("openfl._v2.system.System","gc",0x8dcada2d,"openfl._v2.system.System.gc","openfl/_v2/system/System.hx",26,0x02b48b82)
		HX_STACK_LINE(26)
...
::String System_obj::get_deviceID( ){
	HX_STACK_FRAME("openfl._v2.system.System","get_deviceID",0x8c62414b,"openfl._v2.system.System.get_deviceID","openfl/_v2/system/System.hx",43,0x02b48b82)
	HX_STACK_LINE(43)
	return ::openfl::_v2::system::System_obj::lime_get_unique_device_identifier();
}
...
int System_obj::get_totalMemory( ){
	HX_STACK_FRAME("openfl._v2.system.System","get_totalMemory",0x3eff7ecb,"openfl._v2.system.System.get_totalMemory","openfl/_v2/system/System.hx",51,0x02b48b82)
	HX_STACK_LINE(51)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.system.System"), hx::TCanCast< System_obj> ,sStaticFields,sMemberFields,
...
{
	lime_get_unique_device_identifier= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_get_unique_device_identifier"),(int)0);
}
