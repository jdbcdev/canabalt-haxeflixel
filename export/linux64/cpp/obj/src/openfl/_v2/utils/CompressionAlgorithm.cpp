...
::openfl::_v2::utils::CompressionAlgorithm CompressionAlgorithm_obj::DEFLATE;

::openfl::_v2::utils::CompressionAlgorithm CompressionAlgorithm_obj::GZIP;

::openfl::_v2::utils::CompressionAlgorithm CompressionAlgorithm_obj::LZMA;

::openfl::_v2::utils::CompressionAlgorithm CompressionAlgorithm_obj::ZLIB;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.utils.CompressionAlgorithm"), hx::TCanCast< CompressionAlgorithm_obj >,sStaticFields,sMemberFields,
