...
::openfl::_v2::events::Event MouseEvent_obj::clone( ){
	...
	HX_STACK_LINE(67)
	return ::openfl::_v2::events::MouseEvent_obj::__new(_g,_g1,_g2,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
}
