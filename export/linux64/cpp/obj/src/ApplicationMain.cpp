...
Void ApplicationMain_obj::main( ){
{
				...
				HX_STACK_CATCHABLE(Dynamic, 0);
				{
					struct _Function_3_1{
						inline static bool Block( ){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",73,0x0780ded5)
							{
								HX_STACK_LINE(73)
								::String path = (::Sys_obj::getCwd() + HX_CSTRING("/lime.ndll"));		HX_STACK_VAR(path,"path");
								HX_STACK_LINE(73)
					...
					if ((!(_Function_3_1::Block()))){
						HX_STACK_LINE(75)
						::Sys_obj::setCwd(::haxe::io::Path_obj::directory(::Sys_obj::executablePath()));
					}
				}
				}
				catch(Dynamic __e){
		...
		HX_STACK_LINE(38)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)960,(int)640,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::RESIZABLE))) | int((int)0))) | int(::openfl::_v2::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("FlixelTut"),null(),null());
	}
return null();
}
