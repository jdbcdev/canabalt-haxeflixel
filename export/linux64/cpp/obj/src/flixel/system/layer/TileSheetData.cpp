...
::flixel::system::layer::frames::FlxSpriteFrames TileSheetData_obj::getSpriteSheetFrames( ::flixel::system::layer::Region region,::openfl::_v2::geom::Point origin){
	...
	if (((origin == null()))){
		HX_STACK_LINE(98)
		::openfl::_v2::geom::Point _g = ::openfl::_v2::geom::Point_obj::__new(pointX,pointY);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(98)
		tempPoint = _g;
	}
	HX_STACK_LINE(101)
		...
		while((true)){
			...
			HX_STACK_LINE(111)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(113)
					::openfl::_v2::geom::Rectangle _g11 = ::openfl::_v2::geom::Rectangle_obj::__new((startX + (i * spacedWidth)),(startY + (j * spacedHeight)),width,height);		HX_STACK_VAR(_g11,"_g11");
					HX_STACK_LINE(113)
					tempRect = _g11;
					HX_STACK_LINE(114)
	...
	HX_STACK_ARG(startY,"startY")
{
		...
		HX_STACK_LINE(273)
		::openfl::_v2::geom::Rectangle _g2 = frameData->frame->clone();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(273)
		texFrame->frame = _g2;
		HX_STACK_LINE(275)
		if ((frameData->rotated)){
