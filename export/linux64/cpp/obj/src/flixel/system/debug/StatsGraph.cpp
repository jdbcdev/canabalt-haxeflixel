...
int LabelWidth = __o_LabelWidth.Default(45);
{
	...
	HX_STACK_LINE(57)
	::openfl::_v2::text::TextField _g1 = ::flixel::system::debug::DebuggerUtil_obj::createTextField((int)0,(int)0,(int)-1426063361,(int)11);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(57)
	this->maxLabel = _g1;
	HX_STACK_LINE(58)
	::openfl::_v2::text::TextField _g2 = ::flixel::system::debug::DebuggerUtil_obj::createTextField((int)0,((Float(this->_height) / Float((int)2)) - 5.5),this->graphColor,(int)11);		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(58)
	this->curLabel = _g2;
	HX_STACK_LINE(59)
	::openfl::_v2::text::TextField _g3 = ::flixel::system::debug::DebuggerUtil_obj::createTextField((int)0,(this->_height - (int)11),(int)-1426063361,(int)11);		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(59)
	this->minLabel = _g3;
	HX_STACK_LINE(61)
	::openfl::_v2::text::TextField _g4 = ::flixel::system::debug::DebuggerUtil_obj::createTextField((this->_labelWidth + (int)20),(((Float(this->_height) / Float((int)2)) - 5.5) - (int)10),(int)-1426063361,(int)11);		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(61)
	this->avgLabel = _g4;
	HX_STACK_LINE(62)
