...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(38)
	::openfl::_v2::text::TextFormat _g2 = ::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(38)
	...
	HX_STACK_ARG(FireOnce,"FireOnce")
{
		...
		if (((this->_lines->length > (int)200))){
			...
			HX_STACK_LINE(129)
			::openfl::_v2::text::TextField _g2 = this->_text;		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(129)
