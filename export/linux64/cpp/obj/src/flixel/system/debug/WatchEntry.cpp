...
HX_STACK_ARG(Custom,"Custom")
{
	...
	HX_STACK_LINE(123)
	::openfl::_v2::text::TextFormat _g5 = ::openfl::_v2::text::TextFormat_obj::__new(fontName,(int)12,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(123)
	this->_whiteText = _g5;
	HX_STACK_LINE(124)
	::openfl::_v2::text::TextFormat _g6 = ::openfl::_v2::text::TextFormat_obj::__new(fontName,(int)12,(int)0,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(124)
	this->_blackText = _g6;
	HX_STACK_LINE(126)
