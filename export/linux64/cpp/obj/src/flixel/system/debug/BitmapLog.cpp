...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(57)
	::openfl::_v2::display::BitmapData _g6 = ::openfl::_v2::display::BitmapData_obj::__new(_g2,_g5,true,(int)0,null());		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(57)
...
Void BitmapLog_obj::createHeaderUI( ){
{
		...
		HX_STACK_LINE(89)
		::openfl::_v2::text::TextField _g3 = ::flixel::system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null());		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(89)
		this->_dimensionsText = _g3;
		HX_STACK_LINE(91)
		::openfl::_v2::text::TextField _g4 = ::flixel::system::debug::DebuggerUtil_obj::createTextField((int)0,(int)-3,null(),null());		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(91)
...
Void BitmapLog_obj::createFooterUI( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(114)
		::openfl::_v2::display::BitmapData _g = ::openfl::_v2::display::BitmapData_obj::__new((int)1,(int)15,true,(int)-1157627904,null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(114)
		...
		HX_STACK_LINE(118)
		::openfl::_v2::text::TextField _g2 = ::flixel::system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null());		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(118)
...
Void BitmapLog_obj::resize( Float Width,Float Height){
{
		...
		HX_STACK_LINE(168)
		::openfl::_v2::display::BitmapData _g = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_canvasBitmap->bitmapData);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(168)
		...
		HX_STACK_LINE(169)
		::openfl::_v2::display::BitmapData _g9 = ::openfl::_v2::display::BitmapData_obj::__new(_g3,_g8,true,(int)0,null());		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(169)
	...
	HX_STACK_ARG(name,"name")
{
		...
		HX_STACK_LINE(232)
		::openfl::_v2::display::BitmapData _g = bmp->clone();		HX_STACK_VAR(_g,"_g");
		struct _Function_1_1{
			inline static Dynamic Block( ::openfl::_v2::display::BitmapData &_g,::String &name){
...
Void BitmapLog_obj::clear( ){
{
		...
		this->_entries = Dynamic( Array_obj<Dynamic>::__new());
		HX_STACK_LINE(266)
		::openfl::_v2::geom::Rectangle _g = this->_canvasBitmap->bitmapData->get_rect();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(266)
...
bool BitmapLog_obj::refreshCanvas( Dynamic Index){
	...
	HX_STACK_LINE(308)
	::openfl::_v2::geom::Rectangle _g13 = this->_canvasBitmap->bitmapData->get_rect();		HX_STACK_VAR(_g13,"_g13");
	HX_STACK_LINE(308)
	...
	HX_STACK_LINE(311)
	::openfl::_v2::geom::Rectangle _g14 = this->_canvasBitmap->bitmapData->get_rect();		HX_STACK_VAR(_g14,"_g14");
	HX_STACK_LINE(311)
...
Void BitmapLog_obj::refreshTexts( ){
{
		...
		{
			HX_STACK_LINE(325)
			::openfl::_v2::display::BitmapData bitmapData = this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true);		HX_STACK_VAR(bitmapData,"bitmapData");
			HX_STACK_LINE(325)
