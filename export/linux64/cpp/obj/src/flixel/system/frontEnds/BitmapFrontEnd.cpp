	...
	HX_STACK_ARG(Key,"Key")
{
		...
		if ((!(((  ((this->_cache->exists(key))) ? bool(_Function_1_1::Block(this,key)) : bool(false) ))))){
			HX_STACK_LINE(118)
			::openfl::_v2::display::BitmapData _g3 = ::openfl::_v2::display::BitmapData_obj::__new(Width,Height,true,Color,null());		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(118)
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		if ((!(((  ((this->_cache->exists(key))) ? bool(_Function_1_1::Block(this,key)) : bool(false) ))))){
			...
			if ((isClass)){
				...
				HX_STACK_LINE(249)
				::openfl::_v2::display::BitmapData _g9 = ::Type_obj::createInstance(_g8,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0)));		HX_STACK_VAR(_g9,"_g9");
				HX_STACK_LINE(249)
				bd = _g9;
			}
			else{
				...
				if ((isBitmap)){
					...
					if ((isRegion)){
						...
						if ((isGraphics)){
							...
							HX_STACK_LINE(265)
							::openfl::_v2::display::BitmapData _g10;		HX_STACK_VAR(_g10,"_g10");
							HX_STACK_LINE(265)
							{
								HX_STACK_LINE(265)
								::String id = Graphic;		HX_STACK_VAR(id,"id");
								HX_STACK_LINE(265)
								_g10 = ::openfl::_v2::Assets_obj::getBitmapData(id,false);
							}
							HX_STACK_LINE(265)
							bd = _g10;
						}
			...
			if (((bool((FrameWidth > (int)0)) || bool((FrameHeight > (int)0))))){
				...
				HX_STACK_LINE(276)
				::openfl::_v2::display::BitmapData tempBitmap = ::openfl::_v2::display::BitmapData_obj::__new(_g18,_g20,true,(int)0,null());		HX_STACK_VAR(tempBitmap,"tempBitmap");
				HX_STACK_LINE(277)
				tempBitmap->lock();
				HX_STACK_LINE(278)
			...
			if ((Unique)){
				HX_STACK_LINE(299)
				::openfl::_v2::display::BitmapData _g21 = bd->clone();		HX_STACK_VAR(_g21,"_g21");
				HX_STACK_LINE(299)
				bd = _g21;
			}
			HX_STACK_LINE(302)
