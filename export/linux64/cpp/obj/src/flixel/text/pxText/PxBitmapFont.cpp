		...
		if (((this->_symbols != null()))){
			...
			HX_STACK_LINE(155)
			{
				...
				while((true)){
					...
					++(_g1);
					HX_STACK_LINE(157)
					::openfl::_v2::geom::Rectangle _g12 = ::openfl::_v2::geom::Rectangle_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(_g12,"_g12");
					HX_STACK_LINE(157)
					rect = _g12;
					HX_STACK_LINE(158)
					rect->x = symbol->x;
	...
	while((true)){
		...
		while((true)){
			...
			if (((_g3 != bgColor))){
				...
				HX_STACK_LINE(281)
				::openfl::_v2::geom::Rectangle _g8 = ::openfl::_v2::geom::Rectangle_obj::__new(cx,cy,gw,gh);		HX_STACK_VAR(_g8,"_g8");
				HX_STACK_LINE(281)
				PxRects->push(_g8);
				HX_STACK_LINE(284)
				if (((gh > rowHeight))){
