...
bool EmbeddedFont = __o_EmbeddedFont.Default(true);
{
	...
	HX_STACK_LINE(188)
	::openfl::_v2::text::TextFormat _g1 = ::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEFAULT,Size,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(188)
...
Void FlxText_obj::updateColorTransform( ){
{
		...
		if (((this->alpha != (int)1))){
			...
			if (((this->colorTransform == null()))){
				HX_STACK_LINE(687)
				::openfl::_v2::geom::ColorTransform _g = ::openfl::_v2::geom::ColorTransform_obj::__new((int)1,(int)1,(int)1,this->alpha,null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(687)
	...
	HX_STACK_ARG(RunOnCpp,"RunOnCpp")
{
		...
		if (((  ((!(((  ((!(((this->framePixels == null()))))) ? bool(_Function_1_2::Block(this)) : bool(true) ))))) ? bool(_Function_1_3::Block(this)) : bool(true) ))){
			HX_STACK_LINE(891)
			::openfl::_v2::display::BitmapData _g27 = ::flixel::util::FlxDestroyUtil_obj::dispose(this->framePixels);		HX_STACK_VAR(_g27,"_g27");
			HX_STACK_LINE(891)
			...
			HX_STACK_LINE(892)
			::openfl::_v2::display::BitmapData _g30 = ::openfl::_v2::display::BitmapData_obj::__new(_g28,_g29,true,(int)0,null());		HX_STACK_VAR(_g30,"_g30");
			HX_STACK_LINE(892)
