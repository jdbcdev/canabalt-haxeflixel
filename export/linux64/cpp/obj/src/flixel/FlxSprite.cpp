...
Void FlxSprite_obj::initVars( ){
{
		...
		this->scale = _g7;
		HX_STACK_LINE(216)
		::openfl::_v2::geom::Matrix _g8 = ::openfl::_v2::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(216)
		this->_matrix = _g8;
	}
return null();
...
Void FlxSprite_obj::destroy( ){
{
		...
		this->scale = _g3;
		HX_STACK_LINE(233)
		::openfl::_v2::display::BitmapData _g4 = ::flixel::util::FlxDestroyUtil_obj::dispose(this->framePixels);		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(233)
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		if (((bool((Frame >= (int)0)) || bool(isRegion)))){
			...
			if ((isRegion)){
				HX_STACK_LINE(381)
				::openfl::_v2::display::BitmapData _g1 = ::openfl::_v2::display::BitmapData_obj::__new(tempRegion->width,tempRegion->height,null(),null(),null());		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(381)
				brush = _g1;
				HX_STACK_LINE(382)
	...
	HX_STACK_ARG(alphaOffset,"alphaOffset")
{
		...
		if (((this->colorTransform == null()))){
			HX_STACK_LINE(1067)
			::openfl::_v2::geom::ColorTransform _g1 = ::openfl::_v2::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(1067)
...
Void FlxSprite_obj::updateColorTransform( ){
{
		...
		if (((bool((this->alpha != (int)1)) || bool((this->color != (int)16777215))))){
			...
			if (((this->colorTransform == null()))){
				HX_STACK_LINE(1091)
				::openfl::_v2::geom::ColorTransform _g = ::openfl::_v2::geom::ColorTransform_obj::__new((Float(((int(this->color) >> int((int)16)))) / Float((int)255)),(Float(((int((int(this->color) >> int((int)8))) & int((int)255)))) / Float((int)255)),(Float(((int(this->color) & int((int)255)))) / Float((int)255)),this->alpha,null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(1091)
