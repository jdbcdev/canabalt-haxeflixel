	...
	HX_STACK_ARG(interpolate,"interpolate")
{
		...
		if (((chunkSize == (int)1))){
			...
			HX_STACK_LINE(177)
			::openfl::_v2::display::BitmapData _g2 = ::openfl::_v2::display::BitmapData_obj::__new(width,_g1,true,(int)0,null());		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(177)
			::openfl::_v2::display::Bitmap tempBitmap = ::openfl::_v2::display::Bitmap_obj::__new(_g2,null(),null());		HX_STACK_VAR(tempBitmap,"tempBitmap");
			HX_STACK_LINE(178)
