...
::openfl::_v2::display::BitmapData CachedGraphics_obj::getBitmapFromSystem( ){
	...
	if (((this->assetsClass != null()))){
		...
		HX_STACK_LINE(168)
		::openfl::_v2::display::BitmapData _g1 = ::Type_obj::createInstance(_g,Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(168)
		newBitmap = _g1;
	}
	else{
		...
		if (((this->assetsKey != null()))){
			HX_STACK_LINE(172)
			::openfl::_v2::display::BitmapData _g2 = ::openfl::_v2::Assets_obj::getBitmapData(this->assetsKey,false);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(172)
			newBitmap = _g2;
		}
	}
