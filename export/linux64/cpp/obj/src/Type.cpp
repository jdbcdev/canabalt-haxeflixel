...
::Class Type_obj::getSuperClass( ::Class c){
	HX_STACK_FRAME("Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","/usr/lib/haxe/std/cpp/_std/Type.hx",53,0x728dd546)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(53)
	return c->GetSuper();
}
...
::String Type_obj::getEnumName( ::Enum e){
	HX_STACK_FRAME("Type","getEnumName",0x9b42910e,"Type.getEnumName","/usr/lib/haxe/std/cpp/_std/Type.hx",63,0x728dd546)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(63)
	return e->__ToString();
}
