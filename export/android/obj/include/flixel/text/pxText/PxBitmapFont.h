...
class HXCPP_CLASS_ATTRIBUTES  PxBitmapFont_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::text::pxText::PxBitmapFont loadPixelizer( ::openfl::_v2::display::BitmapData PxBitmapData,::String PxLetters);
		Dynamic loadPixelizer_dyn();

		virtual ::flixel::text::pxText::PxBitmapFont loadAngelCode( ::openfl::_v2::display::BitmapData pBitmapData,::Xml pXMLData);
		...
		virtual ::openfl::_v2::display::BitmapData preparePixelizerBitmapData( ::openfl::_v2::display::BitmapData PxBitmapData,Array< ::Dynamic > PxRects);
		Dynamic preparePixelizerBitmapData_dyn();

		virtual ::openfl::_v2::display::BitmapData prepareAngelCodeBitmapData( ::openfl::_v2::display::BitmapData PxBitmapData,::Xml PxXMLData,Array< ::Dynamic > PxSymbols);
		Dynamic prepareAngelCodeBitmapData_dyn();

		virtual Void dispose( );
		Dynamic dispose_dyn();

		virtual Void setGlyph( ::flixel::system::layer::TileSheetData Tiles,int PxCharID,::openfl::_v2::geom::Rectangle PxRect,hx::Null< int >  PxOffsetX,hx::Null< int >  PxOffsetY,hx::Null< int >  PxAdvanceX);
		...
		::openfl::_v2::display::BitmapData pixels;
		...
		static ::openfl::_v2::geom::Point ZERO_POINT;
