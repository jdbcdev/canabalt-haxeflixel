...
class HXCPP_CLASS_ATTRIBUTES  CachedGraphics_obj : public hx::Object{
	public:
		...
		CachedGraphics_obj();
		Void __construct(::String Key,::openfl::_v2::display::BitmapData Bitmap,hx::Null< bool >  __o_Persist);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< CachedGraphics_obj > __new(::String Key,::openfl::_v2::display::BitmapData Bitmap,hx::Null< bool >  __o_Persist);
