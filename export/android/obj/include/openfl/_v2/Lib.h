...
#define INCLUDED_openfl__v2_Lib
...
HX_DECLARE_CLASS2(openfl,_v2,Lib)
HX_DECLARE_CLASS3(openfl,_v2,display,BitmapData)
HX_DECLARE_CLASS3(openfl,_v2,display,DisplayObject)
HX_DECLARE_CLASS3(openfl,_v2,display,DisplayObjectContainer)
HX_DECLARE_CLASS3(openfl,_v2,display,IBitmapDrawable)
HX_DECLARE_CLASS3(openfl,_v2,display,InteractiveObject)
HX_DECLARE_CLASS3(openfl,_v2,display,ManagedStage)
...
class HXCPP_CLASS_ATTRIBUTES  Lib_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::_v2::display::MovieClip current;
		static ::String file;
		...
		static ::openfl::_v2::display::MovieClip __current;
		...
		static ::openfl::_v2::display::Stage __stage;
		...
		static ::openfl::_v2::display::MovieClip attach( ::String name);
		static Dynamic attach_dyn();

		static Void close( );
		static Dynamic close_dyn();

		static Void create( Dynamic onLoaded,int width,int height,hx::Null< Float >  frameRate,hx::Null< int >  color,hx::Null< int >  flags,::String title,::openfl::_v2::display::BitmapData icon,::Class stageClass);
		static Dynamic create_dyn();

		static ::openfl::_v2::display::ManagedStage createManagedStage( int width,int height,hx::Null< int >  flags);
		...
		static Void getURL( ::openfl::_v2::net::URLRequest url,::String target);
		...
		static Void __setCurrentStage( ::openfl::_v2::display::Stage stage);
		static Dynamic __setCurrentStage_dyn();

		static Void trace( Dynamic arg);
		static Dynamic trace_dyn();

		static ::openfl::_v2::display::MovieClip get_current( );
