...
#define INCLUDED_openfl__v2_utils_JNI
...
HX_DECLARE_CLASS3(openfl,_v2,utils,JNI)
HX_DECLARE_CLASS3(openfl,_v2,utils,JNIMemberField)
HX_DECLARE_CLASS3(openfl,_v2,utils,JNIStaticField)
namespace openfl{
namespace _v2{
namespace utils{
...
class HXCPP_CLASS_ATTRIBUTES  JNI_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::_v2::utils::JNIMemberField createMemberField( ::String className,::String memberName,::String signature);
		...
		static ::openfl::_v2::utils::JNIStaticField createStaticField( ::String className,::String memberName,::String signature);
...
#endif /* INCLUDED_openfl__v2_utils_JNI */ 
