...
{
		HX_STACK_FRAME("openfl._v2.display.Stage","dummyTrace",0xf097e20a,"openfl._v2.display.Stage.dummyTrace","openfl/_v2/display/Stage.hx",360,0xd25d2a60)
		HX_STACK_THIS(this)
		HX_STACK_LINE(360)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),360,HX_CSTRING("openfl._v2.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.Stage","__setActive",0xb282307b,"openfl._v2.display.Stage.__setActive","openfl/_v2/display/Stage.hx",1086,0xd25d2a60)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((  (((focus->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/_v2/display/Stage.hx",1112,0xd25d2a60)
						{
							HX_STACK_LINE(1112)
...
::openfl::_v2::geom::Rectangle Stage_obj::get_softKeyboardRect( ){
	...
	HX_STACK_LINE(1348)
	int height = ::openfl::_v2::display::Stage_obj::lime_get_softkeyboardheight();		HX_STACK_VAR(height,"height");
	HX_STACK_LINE(1350)
	if (((height > (int)0))){
		HX_STACK_LINE(1352)
...
void Stage_obj::__boot()
{
	...
	lime_get_softkeyboardheight= ::openfl::_v2::utils::JNI_obj::createStaticMethod(HX_CSTRING("org.haxe.lime.GameActivity"),HX_CSTRING("getSoftKeyboardHeight"),HX_CSTRING("()F"),null(),null());
}
