...
::openfl::_v2::display::BlendMode BlendMode_obj::ADD;

::openfl::_v2::display::BlendMode BlendMode_obj::ALPHA;

::openfl::_v2::display::BlendMode BlendMode_obj::DARKEN;

::openfl::_v2::display::BlendMode BlendMode_obj::DIFFERENCE;

::openfl::_v2::display::BlendMode BlendMode_obj::ERASE;

::openfl::_v2::display::BlendMode BlendMode_obj::HARDLIGHT;

::openfl::_v2::display::BlendMode BlendMode_obj::INVERT;

::openfl::_v2::display::BlendMode BlendMode_obj::LAYER;

::openfl::_v2::display::BlendMode BlendMode_obj::LIGHTEN;

::openfl::_v2::display::BlendMode BlendMode_obj::MULTIPLY;

::openfl::_v2::display::BlendMode BlendMode_obj::NORMAL;

::openfl::_v2::display::BlendMode BlendMode_obj::OVERLAY;

::openfl::_v2::display::BlendMode BlendMode_obj::SCREEN;

::openfl::_v2::display::BlendMode BlendMode_obj::SUBTRACT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.BlendMode"), hx::TCanCast< BlendMode_obj >,sStaticFields,sMemberFields,
