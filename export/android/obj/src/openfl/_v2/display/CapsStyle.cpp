...
::openfl::_v2::display::CapsStyle CapsStyle_obj::NONE;

::openfl::_v2::display::CapsStyle CapsStyle_obj::ROUND;

::openfl::_v2::display::CapsStyle CapsStyle_obj::SQUARE;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.CapsStyle"), hx::TCanCast< CapsStyle_obj >,sStaticFields,sMemberFields,
