...
::openfl::_v2::display::LineScaleMode LineScaleMode_obj::HORIZONTAL;

::openfl::_v2::display::LineScaleMode LineScaleMode_obj::NONE;

::openfl::_v2::display::LineScaleMode LineScaleMode_obj::NORMAL;

::openfl::_v2::display::LineScaleMode LineScaleMode_obj::OPENGL;

::openfl::_v2::display::LineScaleMode LineScaleMode_obj::VERTICAL;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.LineScaleMode"), hx::TCanCast< LineScaleMode_obj >,sStaticFields,sMemberFields,
