...
::openfl::_v2::media::InternalAudioType InternalAudioType_obj::MUSIC;

::openfl::_v2::media::InternalAudioType InternalAudioType_obj::SOUND;

::openfl::_v2::media::InternalAudioType InternalAudioType_obj::UNKNOWN;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.media.InternalAudioType"), hx::TCanCast< InternalAudioType_obj >,sStaticFields,sMemberFields,
