...
#ifndef INCLUDED_openfl__v2_ui_Keyboard
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.ui.Keyboard"), hx::TCanCast< Keyboard_obj> ,sStaticFields,sMemberFields,
