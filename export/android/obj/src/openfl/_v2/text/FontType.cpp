...
::openfl::_v2::text::FontType FontType_obj::DEVICE;

::openfl::_v2::text::FontType FontType_obj::EMBEDDED;

::openfl::_v2::text::FontType FontType_obj::EMBEDDED_CFF;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.text.FontType"), hx::TCanCast< FontType_obj >,sStaticFields,sMemberFields,
