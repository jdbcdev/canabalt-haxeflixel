...
::openfl::_v2::text::FontStyle FontStyle_obj::BOLD;

::openfl::_v2::text::FontStyle FontStyle_obj::BOLD_ITALIC;

::openfl::_v2::text::FontStyle FontStyle_obj::ITALIC;

::openfl::_v2::text::FontStyle FontStyle_obj::REGULAR;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.text.FontStyle"), hx::TCanCast< FontStyle_obj >,sStaticFields,sMemberFields,
