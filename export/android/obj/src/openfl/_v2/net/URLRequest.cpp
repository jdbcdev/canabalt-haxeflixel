		...
		if (((this->data == null()))){
			...
			if ((::Std_obj::is(this->data,hx::ClassOf< ::openfl::_v2::utils::ByteArray >()))){
				...
				if ((::Std_obj::is(this->data,hx::ClassOf< ::openfl::net::URLVariables >()))){
					...
					HX_STACK_LINE(91)
					::openfl::_v2::utils::ByteArray _g1 = ::openfl::_v2::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(91)
					this->__bytes = _g1;
					HX_STACK_LINE(92)
					...
					if ((::Std_obj::is(this->data,hx::ClassOf< ::String >()))){
						...
						HX_STACK_LINE(97)
						::openfl::_v2::utils::ByteArray _g2 = ::openfl::_v2::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(_g2,"_g2");
						HX_STACK_LINE(97)
						this->__bytes = _g2;
						HX_STACK_LINE(98)
						this->__bytes->writeUTFBytes(str);
