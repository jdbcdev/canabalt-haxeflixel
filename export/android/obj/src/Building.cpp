...
Void Building_obj::createRect( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(205)
		::flixel::FlxSprite rect = ::flixel::FlxSprite_obj::__new((int)0,(int)130,null());		HX_STACK_VAR(rect,"rect");
		HX_STACK_LINE(206)
		rect->makeGraphic(((int)30 * ::Building_obj::TILE_SIZE),((int)20 * ::Building_obj::TILE_SIZE),(int)-1,null(),null());
		HX_STACK_LINE(207)
		this->add(rect);
		HX_STACK_LINE(209)
