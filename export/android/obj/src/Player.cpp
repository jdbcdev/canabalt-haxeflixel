...
Void Player_obj::update( ){
{
		...
		if (((bool((this->jump >= (int)0)) && bool((::flixel::FlxG_obj::mouse->_leftButton->current > (int)0))))){
			...
			HX_STACK_LINE(93)
			::haxe::Log_obj::trace((HX_CSTRING("jump ") + this->jump),hx::SourceInfo(HX_CSTRING("Player.hx"),93,HX_CSTRING("Player"),HX_CSTRING("update")));
			HX_STACK_LINE(94)
			::haxe::Log_obj::trace((HX_CSTRING("jumpLimit ") + this->jumpLimit),hx::SourceInfo(HX_CSTRING("Player.hx"),94,HX_CSTRING("Player"),HX_CSTRING("update")));
			HX_STACK_LINE(96)
			if (((this->jump > this->jumpLimit))){
				HX_STACK_LINE(97)
				::haxe::Log_obj::trace(HX_CSTRING("llego al limite"),hx::SourceInfo(HX_CSTRING("Player.hx"),97,HX_CSTRING("Player"),HX_CSTRING("update")));
				HX_STACK_LINE(98)
				this->jump = (int)-1;
			}
		}
...
{
		HX_STACK_FRAME("Player","onFloor",0xc2cf3a40,"Player.onFloor","Player.hx",125,0xa27fc9dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(125)
		this->jump = (int)0;
	}
...
{
		HX_STACK_FRAME("Player","movement",0x91ad8bbc,"Player.movement","Player.hx",129,0xa27fc9dd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(130)
