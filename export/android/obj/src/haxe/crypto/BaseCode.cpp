...
::String BaseCode_obj::decodeString( ::String s){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decodeString",0x5b4e456a,"haxe.crypto.BaseCode.decodeString","/usr/lib/haxe/std/haxe/crypto/BaseCode.hx",119,0x8057f3fa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(123)
...
::String BaseCode_obj::decode( ::String s,::String base){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decode",0xc13b97b9,"haxe.crypto.BaseCode.decode","/usr/lib/haxe/std/haxe/crypto/BaseCode.hx",132,0x8057f3fa)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(base,"base")
	HX_STACK_LINE(133)
