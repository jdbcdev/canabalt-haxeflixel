...
Void FlxTilemap_obj::updateFrameData( ){
{
		...
		if (((bool((bool((this->cachedGraphics != null())) && bool((this->_tileWidth >= (int)1)))) && bool((this->_tileHeight >= (int)1))))){
			HX_STACK_LINE(1429)
			::openfl::_v2::geom::Point _g = ::openfl::_v2::geom::Point_obj::__new((int)0,(int)0);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(1429)
	...
	HX_STACK_ARG(NewTile,"NewTile")
{
		...
		if (((bool((tile == null())) || bool(!(tile->visible))))){
			...
			HX_STACK_LINE(1479)
			::openfl::_v2::geom::Rectangle _g2 = ::openfl::_v2::geom::Rectangle_obj::__new((rx + this->region->startX),(ry + this->region->startY),this->_tileWidth,this->_tileHeight);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(1479)
			rect = _g2;
		}
		HX_STACK_LINE(1484)
