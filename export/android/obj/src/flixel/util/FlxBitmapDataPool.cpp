	...
	HX_STACK_ARG(exactSize,"exactSize")
{
		...
		while((true)){
			...
			struct _Function_2_1{
				inline static bool Block( ::openfl::_v2::display::BitmapData &bmd,int &w){
			...
			struct _Function_2_2{
				inline static bool Block( ::openfl::_v2::display::BitmapData &bmd,int &h){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxBitmapDataPool.hx",49,0x992b0db1)
					{
						HX_STACK_LINE(49)
		...
		if (((res != null()))){
			...
			HX_STACK_LINE(79)
			::openfl::_v2::display::BitmapData _g5 = ::openfl::_v2::display::BitmapData_obj::__new(w,h,transparent,(  (((fillColor != null()))) ? int(fillColor) : int((int)-1) ),null());		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(79)
			res = _g5;
		}
		HX_STACK_LINE(82)
