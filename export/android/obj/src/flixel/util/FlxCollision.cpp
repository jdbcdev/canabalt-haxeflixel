	...
	HX_STACK_ARG(Camera,"Camera")
{
		...
		if ((considerRotation)){
			...
			HX_STACK_LINE(128)
			::openfl::_v2::display::BitmapData testA2 = ::flixel::util::FlxBitmapDataPool_obj::get(_g24,_g25,true,(int)0,false);		HX_STACK_VAR(testA2,"testA2");
			HX_STACK_LINE(131)
			...
			HX_STACK_LINE(140)
			::openfl::_v2::display::BitmapData testB2 = ::flixel::util::FlxBitmapDataPool_obj::get(_g26,_g27,true,(int)0,false);		HX_STACK_VAR(testB2,"testB2");
			HX_STACK_LINE(141)
