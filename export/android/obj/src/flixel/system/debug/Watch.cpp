...
Void Watch_obj::__construct(::String Title,::openfl::_v2::display::BitmapData Icon,Dynamic Width,Dynamic Height,Dynamic Resizable,::openfl::_v2::geom::Rectangle Bounds,Dynamic Closable)
{
...
hx::ObjectPtr< Watch_obj > Watch_obj::__new(::String Title,::openfl::_v2::display::BitmapData Icon,Dynamic Width,Dynamic Height,Dynamic Resizable,::openfl::_v2::geom::Rectangle Bounds,Dynamic Closable)
