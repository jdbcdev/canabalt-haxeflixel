...
::openfl::_v2::display::BitmapData FlxFrame_obj::paintOnBitmap( ::openfl::_v2::display::BitmapData bmd){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::flixel::system::layer::frames::FlxFrame_obj > __this,::openfl::_v2::display::BitmapData &bmd){
	...
	if (((result == null()))){
		...
		HX_STACK_LINE(78)
		::openfl::_v2::display::BitmapData _g5 = ::openfl::_v2::display::BitmapData_obj::__new(_g3,_g4,true,(int)0,null());		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(78)
		result = _g5;
	}
	HX_STACK_LINE(81)
