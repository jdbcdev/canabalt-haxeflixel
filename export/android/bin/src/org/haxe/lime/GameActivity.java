...
public class GameActivity extends Activity implements SensorEventListener {
	...
	public static int getResourceID (String inFilename) {
		...
		//if (inFilename.equals("assets/music/HaxeFlixel_Tutorial_Game.mp3")) return com.example.myapp.R.raw.assets_music_haxeflixel_tutorial_game_mp3;
		//if (inFilename.equals("assets/music/run.ogg")) return com.example.myapp.R.raw.assets_music_run_ogg;
		//if (inFilename.equals("assets/music/run.mp3")) return com.example.myapp.R.raw.assets_music_run_mp3;
		//if (inFilename.equals("assets/sounds/bomb_explode.mp3")) return com.example.myapp.R.raw.assets_sounds_bomb_explode_mp3;
		//if (inFilename.equals("assets/sounds/bomb_launch.mp3")) return com.example.myapp.R.raw.assets_sounds_bomb_launch_mp3;
		//if (inFilename.equals("assets/sounds/bomb_hit.mp3")) return com.example.myapp.R.raw.assets_sounds_bomb_hit_mp3;
		//if (inFilename.equals("assets/sounds/giant_leg.mp3")) return com.example.myapp.R.raw.assets_sounds_giant_leg_mp3;
		//if (inFilename.equals("assets/sounds/obstacle1.mp3")) return com.example.myapp.R.raw.assets_sounds_obstacle1_mp3;
		//if (inFilename.equals("assets/sounds/footc3.mp3")) return com.example.myapp.R.raw.assets_sounds_footc3_mp3;
		//if (inFilename.equals("assets/sounds/footc2.mp3")) return com.example.myapp.R.raw.assets_sounds_footc2_mp3;
		//if (inFilename.equals("assets/sounds/bomb_pre.mp3")) return com.example.myapp.R.raw.assets_sounds_bomb_pre_mp3;
		//if (inFilename.equals("assets/sounds/wall.mp3")) return com.example.myapp.R.raw.assets_sounds_wall_mp3;
		//if (inFilename.equals("assets/sounds/window1.mp3")) return com.example.myapp.R.raw.assets_sounds_window1_mp3;
		//if (inFilename.equals("assets/sounds/glass1.mp3")) return com.example.myapp.R.raw.assets_sounds_glass1_mp3;
		//if (inFilename.equals("assets/sounds/flyby.mp3")) return com.example.myapp.R.raw.assets_sounds_flyby_mp3;
		//if (inFilename.equals("assets/sounds/obstacle3.mp3")) return com.example.myapp.R.raw.assets_sounds_obstacle3_mp3;
		//if (inFilename.equals("assets/sounds/crumble.mp3")) return com.example.myapp.R.raw.assets_sounds_crumble_mp3;
		//if (inFilename.equals("assets/sounds/foot2.mp3")) return com.example.myapp.R.raw.assets_sounds_foot2_mp3;
		//if (inFilename.equals("assets/sounds/jump1.mp3")) return com.example.myapp.R.raw.assets_sounds_jump1_mp3;
		//if (inFilename.equals("assets/sounds/foot1.mp3")) return com.example.myapp.R.raw.assets_sounds_foot1_mp3;
		//if (inFilename.equals("assets/sounds/footc1.mp3")) return com.example.myapp.R.raw.assets_sounds_footc1_mp3;
		//if (inFilename.equals("assets/sounds/foot4.mp3")) return com.example.myapp.R.raw.assets_sounds_foot4_mp3;
		//if (inFilename.equals("assets/sounds/giant_leg_release.mp3")) return com.example.myapp.R.raw.assets_sounds_giant_leg_release_mp3;
		//if (inFilename.equals("assets/sounds/foot3.mp3")) return com.example.myapp.R.raw.assets_sounds_foot3_mp3;
		//if (inFilename.equals("assets/sounds/flap2.mp3")) return com.example.myapp.R.raw.assets_sounds_flap2_mp3;
		//if (inFilename.equals("assets/sounds/obstacle2.mp3")) return com.example.myapp.R.raw.assets_sounds_obstacle2_mp3;
		//if (inFilename.equals("assets/sounds/window2.mp3")) return com.example.myapp.R.raw.assets_sounds_window2_mp3;
		//if (inFilename.equals("assets/sounds/tumble.mp3")) return com.example.myapp.R.raw.assets_sounds_tumble_mp3;
		//if (inFilename.equals("assets/sounds/footc4.mp3")) return com.example.myapp.R.raw.assets_sounds_footc4_mp3;
		//if (inFilename.equals("assets/sounds/flap3.mp3")) return com.example.myapp.R.raw.assets_sounds_flap3_mp3;
		//if (inFilename.equals("assets/sounds/flap1.mp3")) return com.example.myapp.R.raw.assets_sounds_flap1_mp3;
		//if (inFilename.equals("assets/sounds/jump3.mp3")) return com.example.myapp.R.raw.assets_sounds_jump3_mp3;
		//if (inFilename.equals("assets/sounds/glass2.mp3")) return com.example.myapp.R.raw.assets_sounds_glass2_mp3;
		//if (inFilename.equals("assets/sounds/jump2.mp3")) return com.example.myapp.R.raw.assets_sounds_jump2_mp3;
		//
		//if (inFilename.equals("assets/sounds/crumble.wav")) return com.example.myapp.R.raw.assets_sounds_crumble_wav;
		//if (inFilename.equals("assets/sounds/lose.wav")) return com.example.myapp.R.raw.assets_sounds_lose_wav;
		//if (inFilename.equals("assets/sounds/hurt.wav")) return com.example.myapp.R.raw.assets_sounds_hurt_wav;
		//if (inFilename.equals("assets/sounds/step.wav")) return com.example.myapp.R.raw.assets_sounds_step_wav;
		//if (inFilename.equals("assets/sounds/foot2.wav")) return com.example.myapp.R.raw.assets_sounds_foot2_wav;
		//if (inFilename.equals("assets/sounds/coin.wav")) return com.example.myapp.R.raw.assets_sounds_coin_wav;
		//if (inFilename.equals("assets/sounds/select.wav")) return com.example.myapp.R.raw.assets_sounds_select_wav;
		//if (inFilename.equals("assets/sounds/foot3.wav")) return com.example.myapp.R.raw.assets_sounds_foot3_wav;
		//if (inFilename.equals("assets/sounds/miss.wav")) return com.example.myapp.R.raw.assets_sounds_miss_wav;
		//if (inFilename.equals("assets/sounds/foot1.wav")) return com.example.myapp.R.raw.assets_sounds_foot1_wav;
		//if (inFilename.equals("assets/sounds/fled.wav")) return com.example.myapp.R.raw.assets_sounds_fled_wav;
		//if (inFilename.equals("assets/sounds/foot4.wav")) return com.example.myapp.R.raw.assets_sounds_foot4_wav;
		//if (inFilename.equals("assets/sounds/win.wav")) return com.example.myapp.R.raw.assets_sounds_win_wav;
		//if (inFilename.equals("assets/sounds/combat.wav")) return com.example.myapp.R.raw.assets_sounds_combat_wav;
		//if (inFilename.equals("assets/sounds/jump1.wav")) return com.example.myapp.R.raw.assets_sounds_jump1_wav;
